...
WPS_INCS += -include wps_openssl.h -I$(EXTERNAL_OPENSSL_INC) -I$(EXTERNAL_OPENSSL_INC)/openssl
...
WPSFILES += src/wps/common/shared/slist.c
...
WPS_ROUTERHALFILES += src/wps/brcm_apps/arch/bcm947xx/wps_wl.c
	...
	WPSFILES += src/wps/brcm_apps/apps/wps_ap.c 
		ifeq ($(WPS_UPNP_DEVICE),1)
			WPS_INCS += -I$(SRCBASE)/router/libupnp/include -I$(SRCBASE)/wps/brcm_apps/upnp/WFADevice
