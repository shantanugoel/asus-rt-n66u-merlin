 ...
 *
 * $Id: wpscommon.h 279189 2011-08-23 10:14:21Z kenlo $
 */
...
#define EModeApEnrollee		EModeUnconfAp
#define EModeStaEnrollee	EModeClient
#define EModeStaRegistrar 	EModeRegistrar
