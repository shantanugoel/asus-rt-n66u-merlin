...
function gen_options(){
	if($("upload_bw_min_0").innerHTML == ""){
		...
		for(var j=0; j<5; j++){
			...
			download_bw_desc.innerHTML = "0 ~ " + Math.round(download_bw_min.value*document.form.qos_ibw.value)/100 + " " + $("qos_ibw_scale").value;
		}
	}
	else{
		for(var j=0; j<5; j++){
...
function showQoSList(){
	...
	for(var i = 0; i < rule_desc.length; i++){
		code += '<a><div onmouseover="over_var=1;" onmouseout="over_var=0;" onclick="setClientIP('+i+');"><strong>'+rule_desc[i]+'</strong></div></a>';
	}
				...
				<tr>
		  			...
		  			<div class="formfontdesc"><#UserQoS_desc#></div>
						...
						<table width="100%"  border="1" align="center" cellpadding="4" cellspacing="0" class="FormTable_table" style="margin-top:8px">
							...
							<tr>
								<td width="18%"><input type="text" class="input_12_table" style="float:left;" name="qos_service_name_x_0" onKeyPress="return is_string(this, event)" onblur="if(!over_var){hideClients_Block();}">
								...
								<td width="17%"><input type="text" maxlength="17" class="input_15_table" name="qos_ip_x_0"></td>
								...
								<td width="16%">
									<input type="text" class="input_3_table" onKeyPress="return is_number(this,event);" onblur="conv_to_transf();" name="qos_min_transferred_x_0">~
									<input type="text" class="input_3_table" onKeyPress="return is_number(this,event);" onblur="conv_to_transf();" name="qos_max_transferred_x_0"> KB
