...
var cloud_status;
/*var cloud_synclist_array = '<% nvram_get("cloud_synclist"); %>';*/
var cloud_synclist_array = '<0>jerry5_chang@asus.com>12345678>>/mnt/SanDsik>Sync>1';
					  ...
					  <table width="100%" border="0" cellpadding="5" cellspacing="0" class="FormTitle" id="FormTitle">
							...
							<tr>
							  <td bgcolor="#4D595D" valign="top">
									...
									<table width="100%" height="650px" style="border-collapse:collapse;">
									  <tr bgcolor="#444f53">
									    <td width="20%" height="50">
												<div align="center"><img src="/images/New_ui/USBExt/server.png" width="100px"></div>
											</td>
									    <td width="" rowspan="2">
												<div style="width:95%;font-style:italic;"><#WLANConfig11b_x_WPS_itemdesc#></div>
											</td>
									  ...
									  <tr bgcolor="#444f53">
									    <td height="40"><div align="center" style="margin-top:-30px;font-size: 18px;text-shadow: 1px 1px 1px black;">Cloud Disk</div></td>
									  </tr>
									  ...
									  <tr bgcolor="#444f53">
									    <td width="20%" height="50">
												<div align="center"><img src="/images/New_ui/USBExt/cloudsync.png" width="100px"></div>
											</td>
									    <td width="" rowspan="2">
												<div style="width:95%;font-style:italic;"><#WLANConfig11b_x_WPS_itemdesc#></div>
											</td>
									  ...
									  <tr bgcolor="#444f53">
									    <td height="40"><div align="center" style="margin-top:-30px;font-size: 18px;text-shadow: 1px 1px 1px black;">Smart Access</div></td>
									  </tr>
									  ...
									  <tr bgcolor="#444f53">
									    <td width="20%" height="50">
												<div align="center">
													<img src="/images/cloudsync/cloudsync.png" width="130px">
									  ...
									  <tr bgcolor="#444f53">
									    <td height="40"><div align="center" style="margin-top:-30px;font-size: 18px;text-shadow: 1px 1px 1px black;">Smart Sync</div></td>
									  </tr>
									</table>
