function wl_chanspec_list_change(){
	...
	if (phytype == "a") {	// a mode
		...
		if (band == "1") { // - 5 GHz
			if (bw_cap == "1") { // -- 20 MHz
				...
				if (country == "Q2")
					chanspecs = new Array(0, "40u", "48u", "153u", "161u", "36l", "44l", "149l", "157l");
				else if (country == "EU")
					chanspecs = new Array(0, "40u", "48u", "36l", "44l");
				else if (country == "TW")
					chanspecs = new Array(0, "64u", "153u", "161u", "60l", "149l", "157l");
				else if (country == "CN")
					chanspecs = new Array(0, "153u", "161u", "149l", "157l");
				else // US
					chanspecs = new Array(0, "40u", "48u", "153u", "161u", "36l", "44l", "149l", "157l");
			} 
			else if (bw_cap == "3") { // -- 80 MHz
				if (country == "Q2")
					chanspecs = new Array("36/80", "40/80", "44/80", "48/80", "149/80", "153/80", "157/80", "161/80");
				else if (country == "EU")
					chanspecs = new Array("36/80", "40/80", "44/80", "48/80");
				else if (country == "TW")
					chanspecs = new Array("149/80", "153/80", "157/80", "161/80");
				else if (country == "CN")
					chanspecs = new Array("149/80", "153/80", "157/80", "161/80");
				else // US
					chanspecs = new Array("36/80", "40/80", "44/80", "48/80", "149/80", "153/80", "157/80", "161/80");
			...
			if (bw_cap == "1") { // -- 20 MHz
				...
				if (country == "Q2")
					chanspecs = new Array(0, "5u", "6u", "7u", "8u", "9u", "10u", "11u", "1l", "2l", "3l", "4l", "5l", "6l", "7l");
				else if (country == "EU")
					chanspecs = new Array(0, "5u", "6u", "7u", "8u", "9u", "10u", "11u", "12u", "13u", "1l", "2l", "3l", "4l", "5l", "6l", "7l", "8l", "9l");
				else if (country == "TW")
					chanspecs = new Array(0, "5u", "6u", "7u", "8u", "9u", "10u", "11u", "1l", "2l", "3l", "4l", "5l", "6l", "7l");
				else if (country == "CN")
					chanspecs = new Array(0, "5u", "6u", "7u", "8u", "9u", "10u", "11u", "12u", "13u", "1l", "2l", "3l", "4l", "5l", "6l", "7l", "8l", "9l");
	...
	for (var i in chanspecs) {
		if (chanspecs[i] == 0)
			...
			document.form.wl_chanspec[i] = new Option(chanspecs[i], chanspecs[i]);
